...
const ChatLayout = ({ defaultLayout = [320, 480], users }: ChatLayoutProps) => {
    ...
    return <ResizablePanelGroup
        ...
        className="h-full items-stretch bg-background text-foreground rounded-lg"
    ...
    >
        ...
        <ResizablePanel defaultSize={defaultLayout[1]} minSize={30}>
            {!selectedUser?.selectedUser && <div className='flex justify-center items-center h-full w-full px-10'>
            ...
            {
                selectedUser?.selectedUser && <MessageContainer />
            }
        </ResizablePanel>
